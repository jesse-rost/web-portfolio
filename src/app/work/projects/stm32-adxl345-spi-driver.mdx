---
title: "Bare-Metal SPI & ADXL345 Sensor Driver"
publishedAt: "2026-04-01"
summary: "A register-level full-duplex SPI engine coded on an STM32F411 MCU to acquire atomic 6-byte burst data from a 3-axis accelerometer."
images:
