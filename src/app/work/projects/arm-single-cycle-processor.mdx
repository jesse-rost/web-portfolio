````markdown
---
title: "ARMv7 Single-Cycle Processor & System-on-Chip (SoC)"
publishedAt: "2024-12-15"
summary: "A real-time embedded hardware-software system featuring a custom 32-bit single-cycle CPU core architecture synthesized on an Intel MAX 10 FPGA."
images:
