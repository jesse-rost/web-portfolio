...
summary: "A real-time embedded monitoring system developed on an STM32F411 ARM Cortex-M4 microcontroller utilizing a custom round-robin cooperative scheduler."
images:
